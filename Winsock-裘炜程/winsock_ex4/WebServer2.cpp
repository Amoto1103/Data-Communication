...
#define OK_IMAGE_gif  "HTTP/1.0 200 OK\r\nContent-Type:image/gif\r\n\r\n"
#define OK_IMAGE_png  "HTTP/1.0 200 OK\r\nContent-Type:image/png\r\n\r\n"
...
void handle_get(void* in_arg)
{
	...
	{
		strcpy_s(out_buf, "<html><body><hr>This is a response <b>message</b> in HTML  \
                   format.Please input filename! <font color=red>Wow!</font><hr></body><ml>");
	...
	if (strstr(file_name, ".gif") != NULL)
		strcpy_s(out_buf, OK_IMAGE_gif);
	else if (strstr(file_name, ".png") != NULL)
		strcpy_s(out_buf, OK_IMAGE_png);
	else
